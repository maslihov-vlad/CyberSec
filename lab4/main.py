...
class SBT(Frame):
    ...
    def initUI(self):
        ...
        search_label = Label(self, text="Search:", background='gray', foreground='white')
        ...
        open_button = Button(self, text="Open .audit file", command=self.openFile, style="TButton")
        open_button.grid(sticky=S, row=6, column=0, pady=6, padx=70)

        save_button = Button(self, text="Save .audit file", command=self.saveFile,style="TButton")
        save_button.grid(sticky=S, row=6, column=4, pady=6, padx=70)

        test_button = Button(self, text="Test", command=self.openNewWindow,style="TButton")
        test_button.grid(sticky=S, row=6, column=2, pady=6)


        select_all_button = Button(self, text="Select all options", command=self.selectAll,style="TButton")
        select_all_button.grid(sticky=S, row=6, column=1, pady=6)

        deselect_all_button = Button(self, text="Deselect all options", command=self.deselectAll,style="TButton")
        deselect_all_button.grid(sticky=S, row=7, column=1, pady=6)

        enforce_button = Button(self, text="Enforce", command=self.enforce,style="TButton")
        enforce_button.grid(sticky=S, row=6, column=3, pady=6)

        rollback_button = Button(self, text="Rollback", command=self.rollback,style="TButton")
