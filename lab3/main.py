...
class Audit_Tool(Frame):
    ...
    def initUI(self):
        ...
        select_all_button = Button(self, text="Select All", command=self.selectAll)
        select_all_button.grid(sticky=S, row=6, column=1, pady=6)

        deselect_all_button = Button(self, text="Deselect All", command=self.deselectAll)
    ...
    def openNewWindow(self):
        ...
        for struct in structure:
            if 'description' in struct:
                ...
                desc.append("Tag (description) doesn't exist for current item.")
        ...
        for struct in structure:
            if 'value_data' in struct:
                ...
                val_data.append("Tag (value_data) doesn't exist for current item.")
        ...
        for struct in structure:
            if 'reg_key' in struct:
                ...
                reg_key.append("Tag (reg_key) doesn't exist for current item.")
        ...
        for struct in structure:
            if 'reg_item' in struct:
                ...
                reg_item.append("Tag (reg_item) doesn't exist for current item.")
